...
export const metadata: Metadata = {
  ...
  description:
    'Al Fayasel Laboratories - High-quality pharmaceutical, hair, skin, and paramedical care in Jordan. مختبرات الفياصل - منتجات طبية وتجميلية فائقة الجودة.',
  keywords: [
  ...
  openGraph: {
    ...
    images: [
      {
        url: 'https://alfayasel.com/opengraph-image.jpg',
        width: 1200,
        height: 630,
        type: 'image/jpeg',
  ...
  twitter: {
    ...
    images: ['https://alfayasel.com/opengraph-image.jpg'],
  },
